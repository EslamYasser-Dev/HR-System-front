...
import { SignUpDialog } from "./signupDialog"; // Ensure this component is defined
...
export const Navbar = () => {
  ...
  useEffect(() => {
    const loggedInState = localStorage.getItem("role") === "HR";
        ...
        >
          ...
          {isLoggedIn && (
            <Button
              ...
              variant="faded"
              onPress={() => setSignUpDialogOpen(true)}
            >
              Register
            </Button>
          )}
